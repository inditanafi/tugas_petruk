...
namespace WindowsFormsApplication2
{
    public partial class Form2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into [Penduduk] (No_KK,NIK,Nama,Tempat_lahir,Tanggal_lahir,Jk,Alamt,Agama,Status_kawin,Pekerjaan,Kwarganegaraan) VALUES ('"
        ...
        {
            con.Open();
            string query = "UPDATE Penduduk  SET No_KK='" + text_nokk.Text + 
                "', NIK='" + text_nik.Text + "',Nama = '" + text_nama.Text + "',Tempat_lahir='" + text_tpt_lhr.Text + 
                "',Tanggal_lahir='" + text_tgl_lhr.Text + "',Jk='" + comboBox_jk.Text + "',Alamt='" + text_alamat.Text +
                "',Agama='" + text_agama.Text + "',Status_kawin='" + comboBox_status.Text + "',Pekerjaan='" + text_pekerjaan.Text + 
                "',Kwarganegaraan='" + text_kewarnegaraan.Text + "'WHERE No_KK = '" + text_nokk.Text + "'";
            SqlDataAdapter sdt = new SqlDataAdapter(query, con);
            sdt.SelectCommand.ExecuteNonQuery();
            con.Close();
        ...
        {
            // TODO: This line of code loads data into the 'loginDataSet.admin' table. You can move, or remove it, as needed.
            //this.adminTableAdapter.Fill(this.loginDataSet.admin);
        ...
        private void text_kewarganegaraan_TextChanged(object sender, EventArgs e)
        {

        }

        private void combo_jk_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            con.Open();
            String query = "DELETE FROM [Penduduk] where No_KK = '" + text_nokk.Text + "'";

...
{
    public partial class datamutasi : Form
    {
        public datamutasi()
        {
            InitializeComponent();
        ...
        {
            con.Open();
            string query = "SELECT * FROM mutasi";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into [mutasi] (No_KK,NIK,Nama,Tempat_lahir,Tanggal_lahir,Jk,Alamat,Agama,Status_kawin,Pekerjaan,Kwarganegaraan) VALUES ('" 
                + text_nokk.Text + "','" + text_nik.Text + "','" + text_nama.Text + "','" + text_tpt_lhr.Text + "','" + text_tgl_lhr.Text + "','" 
                + comboBox_jk.Text + "','" + text_alamat.Text + "','" + text_agama.Text + "','" + comboBox_status.Text + "','" + text_pekerjaan.Text + "','" 
                + text_kewarnegaraan.Text + "')";
            cmd.ExecuteNonQuery();
            //SqlDataAdapter sdt = new SqlDataAdapter(query, con);
        ...
        {
            con.Open();
            String query = "DELETE FROM [mutasi] where No_KK = '" + text_nokk.Text + "'";
            SqlDataAdapter SDA = new SqlDataAdapter(query, con);
            SDA.SelectCommand.ExecuteNonQuery();
            con.Close();
        ...
        {
            con.Open();
            string query = "UPDATE mutasi  SET No_KK='" + text_nokk.Text + "', NIK='" + text_nik.Text + 
                "',Nama = '" + text_nama.Text + "',Tempat_lahir='" + text_tpt_lhr.Text + "',Tanggal_lahir='" + text_tgl_lhr.Text + 
                "',Jk='" + comboBox_jk.Text + "',Alamat='" + text_alamat.Text + "',Agama='" + text_agama.Text + 
                "',Status_kawin='" + comboBox_status.Text + "',Pekerjaan='" + text_pekerjaan.Text + "',Kwarganegaraan='" + text_kewarnegaraan.Text + 
                "'WHERE No_KK = '" + text_nokk.Text + "'";
            SqlDataAdapter sdt = new SqlDataAdapter(query, con);
            sdt.SelectCommand.ExecuteNonQuery();
            con.Close();
